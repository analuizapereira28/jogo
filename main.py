...
class Card:
    ...
    def draw(self, surface, x, y):
        if self.flipped:
            pygame.draw.rect(surface, self.color, (x, y, CARD_WIDTH, CARD_HEIGHT))
        else:
            pygame.draw.rect(surface, CARD_BACK_COLOR, (x, y, CARD_WIDTH, CARD_HEIGHT))  # Usar a nova cor aqui
